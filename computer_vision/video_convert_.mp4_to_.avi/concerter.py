'''
python3 concerter.py /home/ghost/Downloads/estimation/new_dataset_eat_throw/domy/ /home/ghost/Downloads/estimation/new_dataset_eat_throw/result/
python3 concerter.py {source} {desctination}
'''
import os
import glob
import ntpath
